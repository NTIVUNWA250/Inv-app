-- =============================================================================
-- 0014_add_item_photo_column.sql
-- =============================================================================
-- Add item_photo_base64 column to corporate_transactions and update the RPC.
-- =============================================================================
...
-- Create updated function that inserts into item_photo_base64
...
DECLARE
  ...
  v_prod JSONB;
BEGIN
  -- Insert the parent transaction record with upfront item photo
