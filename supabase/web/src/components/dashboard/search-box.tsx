...
export function SearchBox() {
  ...
  return (
    <div className="flex h-9 w-full max-w-sm items-center gap-2 rounded-lg border border-line bg-surface px-3 text-sm focus-within:ring-2 focus-within:ring-pink-500">
