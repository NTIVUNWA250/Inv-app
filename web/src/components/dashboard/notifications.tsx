            ...
            {selectedTx && (
                <Dialog open={!!selectedTx} onOpenChange={(open) => !open && setSelectedTx(null)}>
                    <DialogContent className="max-w-md">
                        ...
                        <DialogFooter className="grid grid-cols-2 gap-2 sm:flex sm:justify-end sm:gap-3 mt-6">
                            <Button
                                variant="outline"
                                className="w-full sm:w-36 border-destructive/30 hover:bg-destructive/10 text-destructive font-semibold h-9"
                            ...
                            <Button
                                className="w-full sm:w-36 font-semibold h-9"
                                onClick={() => handleResolve(selectedTx.id, "approved")}
                                disabled={isResolving !== null}
                            >
                                {isResolving === "approved" ? "Approving..." : "Approve"}
                            </Button>
                        </DialogFooter>
                    </DialogContent>
                </Dialog>
